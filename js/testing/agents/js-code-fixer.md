...
4. **Don't break tests.** If the project has a test script and tests cover the files you touched, run them after your changes (use the js-test-authoring skill for detection/commands) and confirm they still pass. If a fix breaks a test, either correct the fix or report the conflict — don't delete or weaken the test.
